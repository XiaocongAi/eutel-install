...
class Eutelescope(MarlinPKG):
    ...
    def preCheckDeps(self):
     ...
     #   self.env[ "EIGEN2_INCLUDE_DIR" ] = self.installPath + "/external/Eigen"
     #   self.env[ "EIGEN3_INCLUDE_DIR" ] = self.installPath + "/external/Eigen"
     #   self.envpath["PATH"].append( '$EIGEN2_INCLUDE_DIR' )
     #   self.envpath["PATH"].append( '$EIGEN3_INCLUDE_DIR' )
