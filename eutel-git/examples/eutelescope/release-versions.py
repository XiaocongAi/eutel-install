...
#Geant4_path="/home/ilcsoft/v01-15/geant4/9.5.p01" 
#version 10.00 is on disk

# compiles this not: ROOT_version = "5.34.18" 
...
Mokka_version = "trunk" 
Mokka_path = "/home/ilcsoft/v01-15/Mokka/trunk"
...
#--- EUTelescope et al:
Eutelescope_version = "tags/v1.0" # e.g. "tags/v00-09-00" (checked out via SVN) or "trunk" for git clone of the current dev version
Eudaq_version = "tags/v2.0.0" # e.g. "tags/v1.2.2" (checked out via SVN) or "trunk" for a full git clone of the current development version
Millepede2_version = 'tags/V04-00-02'
AllPix_version = 'tags/AllPix_v1.0'
