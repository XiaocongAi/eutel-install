...
#--- EUTelescope et al:
Eutelescope_version = "v1.0" # e.g. "tags/v00-09-00" (checked out via SVN) or "trunk" for git clone of the current dev version
Eudaq_version = "tags/v1.6-dev-end" # e.g. "tags/v1.2.2" (checked out via SVN) or "trunk" for a full git clone of the current development version
